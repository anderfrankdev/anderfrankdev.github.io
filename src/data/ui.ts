...
export const workSlides: UiData["slide"][] = [
  {
    title: "About my work",
    content: `As an open source and freelance developer I work to create and design interactive and accesible websites and applications that provide value to my clients, users, or the open source community.`,
    action: {
      text: "About my approach",
      link: "#",
    },
