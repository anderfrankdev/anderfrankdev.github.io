      ...
      >
        ...
        <section>
          <h2 class={`text-5xl my-8 py-4`}>
            {lan.value === "en" ? workSlides[1].title : workSlidesES[1].title}
          </h2>
          <p class={`font-normal text-lg`}>
            {lan.value === "en"
                ...
                <ul class="flex mb-8 mt-8 px-0 justify-start flex-wrap gap-8">
                  {knowledge.tools.map((tool) => (
                    <li
                      key={tool.name}
                      class={
                        "dark:bg-red-900 dark:hover:bg-black hover:bg-red-800 flex rounded-xl mx-4 pl-4 pr-6 items-center py-2 text-sm bg-black relative"
                      }
                    >
                      ...
                      <span
                        class={
                          "absolute right-[-1rem] rounded-full p-3 bg-white"
                        }
                      >
                        <img width={24} height={24} class="" src={tool.image} />
                      </span>{" "}
                    </li>
                  ))}
                </ul>
        ...
        <section class={"mt-20 mb-16"}>
          <h2 class={`text-5xl my-8 py-4`}>
            {lan.value === "en" ? workSlides[2].title : workSlidesES[2].title}
          </h2>
          <p class={`font-normal text-lg`}>
            {lan.value === "en"
